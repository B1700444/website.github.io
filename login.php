            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="section-heading text-uppercase" style="color:white;">Login</h2><br/>
                    </div>
                </div>
                <?php
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="help-block text-danger"></p>
                                        <a href="signup.php" style="float:right;color: #ff4f57;">New user? Click here to Sign up.</a><br>
                                    </div>
