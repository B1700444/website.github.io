...
<?php
$sql = "SELECT * FROM `servicesessions` WHERE `status`= 'Pending' ";
$result = $db->query($sql);
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Available Service Sessions</h2><br>
            </div>
        </div>
        <?php if ($numRows > 0): ?>
            <!--- display all the  available service sessions !-->
            <div class="row">
                <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                    <?php
                    $sql2 = "SELECT * FROM `ctype` WHERE `idctype`=" . $row['stype'] . " LIMIT 1";
                    $result2 = $db->query($sql2);
                    //get the session type Cooking,Cleaning,Driving, Nursing
                    ...
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            ...
                            <p class="text-muted"><?php echo strtoupper($rowctype['name']); ?>
                            </p>
            ...
            <?php else: ?>
                <p></p>
                <h4 class="section-heading text-uppercase">No Sevice Sessions Available</h4><br>
            <?php endif; ?>
        </div>
    </div>
</section>
