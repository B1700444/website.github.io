    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase"style="color:white">Update Info</h2><br/>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 text-center">
                                    ...
                                    <?php if ($userType == 1): ?>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="level" name="level">
                                                <option value="1"  <?php echo $one; ?>>Cooking</option>
                                                <option value="2"  <?php echo $two; ?>>Cleaning</option>
                                                <option value="3" <?php echo $three; ?>>Driving</option>
                                                <option value="4" <?php echo $three; ?>>Nursing</option>
                                            </select>
                                        </div>
                                    <?php else: ?>
                                        <div class="form-group">
