            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="section-heading text-uppercase"style="color:white">Sign Up</h2><br/>
                    </div>
                </div>
...
<!-- <input id="selmemtype" name="selmemtype" type="hidden" value="1" /> -->
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" style="color:#ff4f57;" data-toggle="tab" href="#
                        " role="tab">Service Provider</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color:#ff4f57;" data-toggle="tab" href="#trainer" role="tab">Senior Citizen</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="member" role="tabpanel"><br/>
                        <div class="row">
                                ...
                                <form   id="contactForm" method="POST" novalidate>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" id="maddress" type="text" placeholder="Address *" required data-validation-required-message="Please enter your Address.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                            <div class="form-group">
                                                <label for="level" style="color:white;">Service Type</label>
                                                <select class="form-control" id="level">
                                                    <option value="1">1212 - Cooking</option>
                                                    <option value="2">4343 - Cleaning</option>
                                                    <option value="3">5454 - Driving</option>
                                                </select>
                                            </div>
