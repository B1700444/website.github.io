            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <?php // $_SESSION['usertype'];// USER TYpe = 1 Senior , 2= Service Provider     ?>
                        <?php if ($_SESSION['usertype'] == 2): ?>
                            <li class="nav-item">
                                <a class="nav-link js-scroll-trigger" href="requestService.php">Request Service</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link js-scroll-trigger" href="viewHistorySenior.php">View Service History</a>
                            </li>
                        <?php endif; ?>
                        <!-- if member show this !-->
                        <?php if ($_SESSION['usertype'] == 1): ?>
                            <li class="nav-item">
                                <a class="nav-link js-scroll-trigger" href="registerSession.php">Accept Service</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link js-scroll-trigger" href="viewHistoryMember.php">View Service History</a>
                            </li>
                        <?php endif; ?>
